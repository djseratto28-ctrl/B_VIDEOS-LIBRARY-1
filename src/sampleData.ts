...
export const INITIAL_MOVIES: Movie[] = [
  ...
  },
  {
    ...
    description: "Neo and the rebel leaders estimate that they have 72 hours until 250,000 sentinels discover Zion and destroy it and its inhabitants.",
    category: "Sci-Fi",
    videoUrl: "https://www.youtube.com/watch?v=kYzz0FSgpSU",
    thumbnailUrl: "https://picsum.photos/seed/matrix/800/1200",
    vj: "VJ Emmy",
    quality: "HD",
    order: 4,
    releaseYear: 2003,
